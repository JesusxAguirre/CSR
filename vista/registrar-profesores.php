...
<body>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box">
              <h4 class="page-title">Registrar Profesores</h4>
            </div>
          </div>
        </div>
        <div class="row mt-2">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mb-3 mt-3 row">
                  <div class="col">
                    <label class="form-label fw-bold" for="">Escoge los profesores</label>
                    <select name="profesores[]" class="form-select" id="profesores" placeholder="This is a placeholder" multiple>
                    <option value="1">Jesus Canelon es marico</option>  
                  </select>
                  </div>
                </div>
  ...
  <script>
    var PrimerElement = new Choices('#profesores', {
      allowSearch: false
    })
