...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">Casa Sobre La Roca</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Fe - Paz - Amor</p>
        </div>
    </header>
    <!-- Portfolio Section-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <p class="lead">Somos una gran comunidad que evangeliza en todo barquisimeto</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Carrera 18 con calle 41
                        <br />
                        Edificio Griss La roca, Barquisimeto. Edo.Lara
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">ECAM</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <img class="img-fluid rounded mb-5" src="resources\img\pizarra.png" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Academia donde preparamos a todos nuestros feligreces, tenemos mas de 10 profesores , 3 niveles de preparacion, con cada uno mas de 10 materias, que esperas ven ya!</p>
                ...
                <div class="modal-body text-center pb-5">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <!-- Portfolio Modal - Title-->
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Ubicacion</h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <!-- Portfolio Modal - Image-->
                                <img style="width: 30vh; height:j 22vh; margin-top: 10px;" class="img-fluid" src="resources\img\ubicacion.jpg" alt="..." />

                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4">Tenemos mas de 10 iglesias, pero la principal es la de la carrera 19 con calle 41 edificio griss, centro de barquisimeto estado lara</p>
                                <button class="btn btn-primary" data-bs-dismiss="modal">
                                    <i class="fas fa-xmark fa-fw"></i>
                                    Cerrar Ventana
                                </button>
