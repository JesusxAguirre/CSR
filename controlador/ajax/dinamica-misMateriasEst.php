            ...
            <div class="col-sm col-lg-3 mt-3 me-3">
                <div class="card sombra hover">
                    ...
                    <div class="d-grip">
                        ...
                        <button class="verContenido btn btn-outline-success w-100" data-bs-toggle="modal" data-bs-target="#modal_misContenidosEst">Ver Descripcion <i class="bi bi-body-text"></i></button>
                    </div>
                </div>
            </div>
    <?php } ?>
